...
feature_list_relative = ['rows', 'nonzeros_relative', 'posdef', 'nsym', 'psym', 'density',
...
features = np.array(data[feature_list_relative])
...
def train(classifier):
    ...
    if hasattr(classifier, 'feature_importances_'):
        plot_feature_importances(classifier.feature_importances_, feature_list_relative)
